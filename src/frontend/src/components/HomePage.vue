  ...
  data() {
    return {
      ...
      categories: [
        ...
        { name: 'Motherboard', image: { src: require('@/assets/gpu.png'), alt: 'Motherboard' } },
        { name: 'RAM', image: { src: require('@/assets/gpu.png'), alt: 'RAM' } },
        { name: 'Storage', image: { src: require('@/assets/gpu.png'), alt: 'Storage' } },
        { name: 'PSU', image: { src: require('@/assets/gpu.png'), alt: 'PSU' } },
        { name: 'Case', image: { src: require('@/assets/gpu.png'), alt: 'Case' } },
        { name: 'Peripherals', image: { src: require('@/assets/gpu.png'), alt: 'Peripherals' } },
        { name: 'Monitors', image: { src: require('@/assets/gpu.png'), alt: 'Monitors' } },
        { name: 'Cooling', image: { src: require('@/assets/gpu.png'), alt: 'Cooling' } },
      ],
    };
  },
};
