...
class CustomerServiceTest {
    ...
    void a_setup(){
        ...
        customer1 = CustomerFactory.buildCustomer("01","Zubair", "Benny", "123", contact);
        assertNotNull(customer1);
        Contact contact2 = ContactFactory.buildContact("dprins@gmail.com","098 765 4321", "40 Champion Street", "Cape Town" ,"Western Cape" , "7607", "South Africa");
        customer2 = CustomerFactory.buildCustomer("01","Duane", "Prins", "321", contact2);
